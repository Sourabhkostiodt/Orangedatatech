...
import { navbarServiceLinks } from '../data/serviceMenu';
...
const links = [
  { label: 'About Us', href: '/about-us' },
  {
    label: 'Services',
    href: '/services',
    sub: [{ label: 'Services Overview', href: '/services' }, ...navbarServiceLinks],
  },
  {
    label: 'Technologies',
    href: '/technologies',
              ...
              <AnimatePresence>
                {l.sub && drop === l.label && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-2 w-80 max-h-[70vh] overflow-y-auto bg-[#0D0828] border border-white/10 rounded-xl py-2 shadow-2xl"
                  >
                    {l.sub.map((s) => (

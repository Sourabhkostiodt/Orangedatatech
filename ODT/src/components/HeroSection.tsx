...
export default function HeroSection() {
  ...
  return (
    <section id="home" ref={ref} className="relative min-h-screen bg-fort-dark overflow-hidden pt-[76px]">
      <div className="absolute inset-0">
        <img src={BRAND.images.heroBg} alt="" className="w-full h-full object-cover object-center" />
      </div>
      ...
      <div className="absolute top-1/3 right-[15%] w-72 h-72 bg-fort-purple/20 rounded-full blur-[120px]" />

      <div className="container-fort relative z-10 grid lg:grid-cols-2 gap-10 items-center min-h-[calc(100vh-76px)] py-16 lg:py-20">
        <div>
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="text-fort-purple-light text-xs font-semibold uppercase tracking-[0.25em] mb-5">
            Cybersecurity essentials for online safety
          </motion.p>
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }} className="text-[2.6rem] sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
            Modern strategies for <span className="text-gradient-purple">cyber threat</span> protection
          </motion.h1>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.16 }} className="text-white/55 text-base leading-relaxed max-w-md mb-8">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.24 }} className="flex flex-wrap gap-3">
            <a href="#services" className="btn-fort">Get Started</a>
        ...
        <div className="relative flex justify-center items-center min-h-[380px] lg:min-h-[520px]">
          ...
          >
            <img
              ...
              className="w-full h-full object-contain drop-shadow-[0_0_60px_rgba(244,121,32,0.35)]"
            />
          </motion.div>
